      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-12">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-3xl md:text-4xl font-serif text-[#2C2416] mb-2 tracking-tight">
                Our Collection
              </h2>
              <p className="text-[#5C4A3A] font-light text-sm">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-6 border-b border-[#E8E2D5]">
            ...
            <div className="flex items-center gap-3">
              ...
              <select
                ...
                className="text-sm text-[#2C2416] bg-white border border-[#E8E2D5] px-4 py-2 focus:outline-none focus:border-[#8B7355] transition-colors cursor-pointer font-light"
              >
